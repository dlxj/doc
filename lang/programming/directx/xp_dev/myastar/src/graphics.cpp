...
//-----------------------------------------------------------------------------
Graphics::cImage* Graphics::LoadImage (char* szBitmap, char loadTo)
{
...
//-----------------------------------------------------------------------------
int Graphics::SetFont (char* typeface, int typesize, int bold, int italic, 
			 int underline)
{

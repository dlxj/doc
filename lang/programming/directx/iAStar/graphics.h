...
namespace Graphics {
	...
	int InitGraphics (int screenWidth, int screenHeight, int screenDepth, 
				  HWND hWnd, const TCHAR* pPalleteFile = NULL);
	...
	int SetFont (LPCWSTR typeface, int typesize, int bold=0, int italic=0,
			 int underline=0);

	cImage* LoadImage (LPCWSTR szBitmap, char loadTo=0);

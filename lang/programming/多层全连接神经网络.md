...
$$
\frac{\partial}{\partial w^2_{1,j}} \mathcal{L} \ , for \ j \in 1 \cdots m  \\
$$
...
= \frac{1}{2m} \sum^{m}_{s=1} \frac{\partial}{\partial w^2_{1,j}} (h^{2}_{1,s} - y_{1,s})^2    \quad \text{(by linearity of the derivative)} \\

= \frac{1}{2m} \sum^{m}_{s=1} 2 \cdot (h^{2}_{1,s} - y_{1,s}) \frac{\partial}{\partial w^2_{1,j}} (h^{2}_{1,s} - y_{1,s})    \quad \text{(by chain rule)} \\

= 2 \cdot  \frac{1}{2m} \sum^{m}_{s=1} (h^{2}_{1,s} - y_{1,s}) \bigg [ \frac{\partial}{\partial w^2_{1,j}} h^{2}_{1,s} - \frac{\partial}{\partial w^2_{1,j}} y_{1,s} \bigg ]   \quad \text{(by linearity of the derivative)} \\

= \frac{1}{m} \sum^{m}_{s=1} (h^{2}_{1,s} - y_{1,s}) \frac{\partial}{\partial w^2_{1,j}} h^{2}_{1,s} \quad \text{(by linearity of the derivative)} \\
$$

$$
\frac{\partial}{\partial w^2_{1,j}} h^{2}_{1,s} \ , for \ j, s \in 1 \cdots m  \\
= \frac{\partial}{\partial w^2_{1,j}} g(a^2_{1,s})  \\
= g(a^2_{1,s}) (1 - g(a^2_{1,s})) \frac{\partial}{\partial w^2_{1,j}} a^2_{1,s}
$$

$$
\frac{\partial}{\partial w^2_{1,j}} a^2_{1,s} \ , for \ j, s \in 1 \cdots m  \\
= \frac{\partial}{\partial w^2_{1,j}} (w^2_{1,*} \cdot x^1_{*,s} + b^2_{1,s})
$$

...
module.exports = {
    ...
    clean: function (str) {
        str = str.replaceAll(/<font.+?>/g, '').replaceAll(/<\/.+?>/g, '').replaceAll(/<b>/g, '').replaceAll(String.raw`{\\an7}`, '').replaceAll(/\r\n/g, '\n')
        return str
    },
    parse: function (str) {
    ...
    // allinone: function (subsjpch) {

    //     let subs = []

    //     for (let i = 0; i < subsjpch.length; i++) {
    ...
    mergev2: function (subsjp, subszh) {

...
#include "../../goldendict/fulltextsearch.hh"
...
static const char qt_meta_stringdata_FTS__FullTextSearchDialog[] = {
    ...
    "ignoreWordsOrderClicked()\0"
    "ignoreDiacriticsClicked()\0searchReqFinished()\0"
    "reject()\0idx\0itemClicked(QModelIndex)\0"
    "updateDictionaries()\0helpRequested()\0"
};
...
void FTS::FullTextSearchDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->showTranslationFor((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QStringList(*)>(_a[2])),(*reinterpret_cast< const QRegExp(*)>(_a[3])),(*reinterpret_cast< bool(*)>(_a[4]))); break;
        ...
        case 6: _t->ignoreWordsOrderClicked(); break;
        case 7: _t->ignoreDiacriticsClicked(); break;
        case 8: _t->searchReqFinished(); break;
        case 9: _t->reject(); break;
        case 10: _t->itemClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 11: _t->updateDictionaries(); break;
...
// SIGNAL 0
void FTS::FullTextSearchDialog::showTranslationFor(QString const & _t1, QStringList const & _t2, QRegExp const & _t3, bool _t4)
{

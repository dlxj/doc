...
int main(int argc, char *argv[])
{
    ...
    senten_words.insert(std::pair<string, vector<string> >( "a c b",  vector<string>({"a", "b", "c"}) ) );
    senten_words.insert(std::pair<string, vector<string> >( "b a c",  vector<string>({"a", "b", "c"}) ) );

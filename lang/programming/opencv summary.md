...
using System.IO;
        ...
        public static string paiban(string strAliyunOCRJson, Tuple<OpenCvSharp.Point, OpenCvSharp.Point> points = null)
        {
            ...
            //File.WriteAllText(@"D:\workcode\csharp\aliyun_ocr\result.txt", result, new System.Text.UTF8Encoding(false));

            //File.WriteAllText(@"D:\workcode\csharp\aliyun_ocr\result_origin.txt", ori_results, new System.Text.UTF8Encoding(false));

# -*- coding: utf-8 -*-
"""
Created on Wed Dec  5 23:55:58 2018
...
for c, mu, sigma in zip(np.arange(2), mus, sigmas):
    ...
    ax.set_title(r"$\delta_1^2={:.3f},\ \delta_2^2={:.3f}$".format(sigma[0][0] ** 0.5, sigma[1][1] ** 0.5), fontsize=TEXT_FONT_SIZE)

plt.savefig(os.path.join(all_pic_path, '5-7.png'), format='png')
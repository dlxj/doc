# -*- coding: utf-8 -*-
"""
Created on Sun Dec  9 12:52:40 2018
...
def sum_of_logistic(x, y):
    s = logistic(w1, b1, x, y)+logistic(w2, b2, x, y)+logistic(w3, b3, x, y)
    return s
...
plt.savefig(os.path.join(all_pic_path, '6-3.png'), format='png')
# -*- coding: utf-8 -*-
"""
Created on Mon Dec  3 23:26:10 2018
...
for i, label in zip(np.arange(2), labels):
    ...
    ax.text(p[0]-0.2, p[1], minv-0.8, label, fontsize=TEXT_FONT_SIZE)
    ...
    ax.add_artist(arrow)
    # ax.text(p_next[0]-0.2, p_next[1], minv-0.8, labels[i + 1], fontsize=TEXT_FONT_SIZE)
...
plt.savefig(os.path.join(all_pic_path, '4-8.png'), format='png')
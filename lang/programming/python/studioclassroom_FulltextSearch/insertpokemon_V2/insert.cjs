...
( async()=>{
    ...
    let [hirass, msgg] = await libmecab.haras("お願いします! ピカピカ! ")
    ...
    let { default:execa } = await import('execa')
...
/mnt/videos/anime/Pokemon/S14/Best_Wishes


"お願いします! ピカピカ! "

let [hiras, msg] = await libmecab.haras("お願いします! ピカピカ! ")

...
QT_MOC_LITERAL(1, 18, 11), // "focusSearch"
QT_MOC_LITERAL(2, 30, 0) // ""

    },
    "GlobalEventFilter\0focusSearch\0"
};
...
void GlobalEventFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (GlobalEventFilter::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GlobalEventFilter::focusSearch)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject GlobalEventFilter::staticMetaObject = { {
    ...
    qt_meta_stringdata_GlobalEventFilter.data,
    qt_meta_data_GlobalEventFilter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 0
void GlobalEventFilter::focusSearch()
{

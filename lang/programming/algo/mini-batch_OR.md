...
$$
\frac{ \partial }{ \partial w_{2,1} } L = - \frac{1}{2} p_{1,1}(1 - q_{1,1}) x_{1,2}  + \frac{1}{2} p_{1,2} q_{1,1} x_{1,2}  \\

- \frac{1}{2} p_{2,1} (1 - q_{2,1}) x_{2,2}  + \frac{1}{2} p_{2,2} q_{2,1} x_{2,2}
$$

# -*- coding: utf-8 -*-
"""IPINGCHOU_HW8_Seq2Seq.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1S6OHOxLiGZh_XL4qKYOBnzuAxGLNloAA

https://github.com/IPINGCHOU/NTU_MachineLearning/tree/master/HW8_Seq2Seq
"""

# ! git clone https://github.com/cegfdb/NTU_MachineLearning.git
...
class configurations(object):
  def __init__(self):
    ...
    self.hid_dim = 512
    self.n_layers = 3
    self.dropout = 0.5                    # dropout 是決定有多少的機率會將某個節點變為 0，主要是為了防止 overfitting ，一般來說是在訓練時使用，測試時則不使用
...
if __name__ == '__main__':
  #input_path = '/content/NTU_MachineLearning/HW8_Seq2Seq/cmn-eng' # sys.argv[1]
